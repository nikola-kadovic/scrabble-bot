...
U = Letter.U; V = Letter.V; W = Letter.W; X = Letter.X; Y = Letter.Y
Z = Letter.Z; BLANK = Letter.BLANK
...
class Arc:
    ...
    def __init__(self,
                 ...
                 destination_state: Optional[State] = None) -> None: ...

class State:
    arcs: dict[str, Arc]
    letters_that_make_a_word: set[str]
    def __init__(self) -> None: ...
    def add_arc(self, letter: str,
                destination_state: Optional[State] = None) -> State: ...
...
class Gaddag:
    ...
    def build_from_file(self, wordlist_path: str,
